# 🗂 UtilityWare — Category Index

**17 categories** containing **178 tools** in total.
...
## 4. 🖥️ [System Utilities](./system-utils/)
...
## 6. 🌐 [Network Utilities](./network-utils/)
...
## 7. 🛠️ [Developer Utilities](./dev-utils/)
...
## 10. 🎉 [Fun & Toys](./fun-utils/)

Because terminals deserve personality: matrix rain, fake hacker mode, fortune cookies.
...
## 11. 🎨 [Media Utilities](./media-utils/)
...
## 12. 🔒 [Security Utilities](./security-utils/)
...
## 14. 🐳 [Docker Utilities](./docker-utils/)
...
## 15. 🖥️ [Terminal Utilities](./terminal-utils/)

Profile, theme, and tune the terminal itself: colors, fonts, prompt segments.
...
## 16. 🐍 [Python Utilities](./python-utils/)
